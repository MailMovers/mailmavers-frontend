...
import { getAddress, getAddressNurserySchools } from '@/api/letter';
...
const NurseryAddressList = (props: { clickModal: any }) => {
  ...
  const { data } = useSWR<NurserySchools[]>(url, getAddressNurserySchools);
...
export default NurseryAddressList;
